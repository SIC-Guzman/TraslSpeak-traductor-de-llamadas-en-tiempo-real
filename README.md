...
⚙️ Configuración Crítica (app.py)
...
Nota Pro: Puedes cambiar el género de las voces en el selector central en cualquier momento; la siguiente frase ya saldrá con el nuevo género.
